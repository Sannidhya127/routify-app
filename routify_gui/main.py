...
class Routify(customtkinter.CTk):
    def __init__(self):
        ...
        self.central_label = customtkinter.CTkLabel(self, text="")
        self.central_label.grid(row=0, column=1, padx=(20, 0), pady=(20, 0), sticky="nsew")
    ...
    def About(self):
        self.central_label.configure(text="About")
